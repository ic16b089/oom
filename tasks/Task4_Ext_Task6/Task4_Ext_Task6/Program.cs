...
namespace Task4_Ext_Task6
{
	class MainClass
	{
		public static void Main(string[] args)
		{
			...
			Divers_Logbook_PullExample.Run(my_divers_logbook);

			Divers_Logbook_PushExampleWithSubject.Run(my_divers_logbook);

			Divers_Logbook_Task_62.Run(my_divers_logbook);
