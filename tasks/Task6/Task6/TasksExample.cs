//
// only doing testing on available functions from lesson 6 in this project (to understand how it works)
// individual testing is done in MyTask6 and in extentions to my original project
// 17/04/2017 Niedermaier Robert
//
